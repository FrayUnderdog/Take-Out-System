...
public class EmployeeController {
     ...
     */
    @GetMapping("/page")
    @ApiOperation("get info of all employees")
    public Result<PageResult> page(EmployeePageQueryDTO employeePageQueryDTO) {
        log.info("get info of all employees: {}", employeePageQueryDTO);
    ...
    @ApiOperation("start or stop an employee")
    public Result startOrStop(@PathVariable("status") Integer status, Long id) {
        log.info("start or stop an employee: {}, {}", status, id);
